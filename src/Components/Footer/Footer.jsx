    ...
    return (
        <div className='footer'>
            ...
            <div className='social-icons'>
                <a href="https://www.instagram.com/thingamajigg_/" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faInstagram} />
                </a>
                <a href="https://www.facebook.com/profile.php?id=61558628079399" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faFacebook} />
                </a>
                <a href="https://wa.me/+60165177619" target="_blank" rel="noopener noreferrer">
